...
const steamLinkClass: string = 'w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-sky-800 hover:bg-sky-700 md:text-lg transition-all duration-300'
...
const Download = ({ className, release }: Props) => (
  <div id="download" className={ className }>
    ...
    <p className="mt-6">Our <a href="https://store.steampowered.com/app/1978800/AQtion/" title="Steam Page" rel="noopener noreferrer" target="_blank">Steam page</a> is the preferred, and easiest method to get up-and-running</p>
